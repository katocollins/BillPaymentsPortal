<%@ Page Title="" Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="VendorRequestLogs.aspx.cs" Inherits="VendorRequestLogs" %>
                                ...
                                <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                                    <tr>
                                        <td class="InterfaceHeaderLabel">
                                           Vendor Request transactions</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                ...
                                <asp:TextBox ID="startDate" TextMode="Date" runat="server" Style="width:90%" CssClass="form-control nunito-font"></asp:TextBox>
                            </td>
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6; border-bottom-width: 1px;
                                border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px;
                                ...
                                <asp:TextBox ID="endDate" TextMode="Date" runat="server" Style="width:90%" CssClass="form-control nunito-font"></asp:TextBox>
                        ...
                        <asp:View runat="server" ID="View4">
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="VendorRequestsGridView" runat="server" 
                                        ...
                                        <PagerStyle CssClass="cssPager" BackColor="#99CCCC" ForeColor="#003399" HorizontalAlign="Center" />
                                                      <Columns>
                                                          <asp:BoundField DataField="VendorTranId" HeaderText="VendorTranId" />
                                                            ...
                                                            <asp:BoundField DataField="XmlResponse" HeaderText="XmlResponse" />
