<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="GenerateProdLicense.aspx.cs" Inherits="GenerateProdLicense" Title="NEW PRODUCTION LICENSE" Culture="auto" UICulture="auto" %>
                    ...
                    <tr>
                        <td style="width: 100%; text-align: center; height: 30px;" class="InterFaceTableLeftRowUp">
                                                                <asp:Button ID="btnOK" runat="server" Font-Size="9pt" Height="23px"
                                                                    Text="GENERATE PROD LICENSE KEY" Width="200px" Font-Bold="True" OnClick="btnOK_Click" style="font: menu" /></td>
                    </tr>
                </table>
