<%@ Page Title="" Language="C#" MasterPageFile="~/AccountantMaster.master" AutoEventWireup="true" CodeFile="ReconciledExceptions.aspx.cs" Inherits="ReconciledExceptions" %>
                    ...
                    <tr>
                        <td style="vertical-align: middle; width: 15%; height: 21px; text-align: center; border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6; border-bottom-width: 1px; border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px; border-right-color: #617da6;">
                            &nbsp;<asp:DropDownList ID="cboBank" runat="server" CssClass="InterfaceDropdownList"
                                Width="95%" style="font: menu" AutoPostBack="true" OnSelectedIndexChanged="cboType_SelectedIndexChanged">
                            </asp:DropDownList></td>
                        <td style="vertical-align: middle; width: 15%; height: 21px; text-align: center; border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6; border-bottom-width: 1px; border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px; border-right-color: #617da6;">
                            <asp:DropDownList ID="ddVendor" runat="server" CssClass="InterfaceDropdownList" AutoPostBack="true" OnSelectedIndexChanged="cboTelecom_SelectedIndexChanged"
            ...
            <td style="width: 98%; height: 2px">
                ...
                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="Bank" HeaderText="Vendor"></asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="BankId" HeaderText="UtilityTranRef"></asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="BankStatus" HeaderText="BankStatus"></asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="ReconciledFlag" HeaderText="ReconStatus"></asp:BoundColumn>
