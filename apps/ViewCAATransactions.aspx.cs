...
namespace apps
{
    public partial class ViewCAATransactions : System.Web.UI.Page
    {
        ...
        protected void btnConvert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable resultTable = bll.CreateDataTable("TransactionIDs", new string[] { "CustomerRef", "PegPayId", "PhoneNumber", "Amount", "Utility", "CAAReference", "Status", "SentToUtility", "RecordDate" });
                ...
                {
                    DataTable dtResult = bll.CheckCAATransactions(TransactionID, Session);
