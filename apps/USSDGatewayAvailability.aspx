        ...
        <td style="width: 98%; height: 2px">
                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="SentPacket" HeaderText="SentPacket"></asp:BoundColumn>
                        <asp:BoundColumn DataField="RecievePackets" HeaderText="RecievePackets"></asp:BoundColumn>
                        <asp:BoundColumn DataField="LostPackets" HeaderText="LostPackets"></asp:BoundColumn>
                         <asp:BoundColumn DataField="PercentageLoss" HeaderText="PercentageLoss"></asp:BoundColumn>
