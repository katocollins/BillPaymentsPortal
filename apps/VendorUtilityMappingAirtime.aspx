<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="VendorUtilityMappingAirtime.aspx.cs" 
    Inherits="VendorUtilityMappingAirtime"
    Culture="auto" 
     UICulture="auto" %>
     <%@ Register 
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            ...
                                            <td class="InterFaceTableLeftRowUp" style="width:25%">
                                                Select Utility:</td>
                                            <td style="width:25%">
                                                <asp:DropDownList ID="ddlUtility" runat="server" CssClass="InterfaceDropdownList" Width="100%" OnSelectedIndexChanged="ddlUtility_SelectedIndexChanged" OnDataBound="ddlUtility_DataBound" AutoPostBack="true">
                                                </asp:DropDownList></td>
                                            
                                        </tr>
                                        <tr>
                                             <td class="InterFaceTableLeftRowUp" style="width:25%">
                                                <label id="namelabel" runat="server">Commission in Percentage</label>
                                             </td>
                                             <td style="width: 100px">
                                                <asp:TextBox ID="txtCommission" runat="server" Style="font: menu" Width="98%"></asp:TextBox>
                                             </td>
                                      <%--      <td class="InterFaceTableLeftRowUp" style="width:25%">
                                                <asp:CheckBox runat="server" Checked="true" Visible="false" Font-Bold="true" ID="UtilApi" Text="Api User" />
                                             </td>
                                             <td style="width: 100px">
                                                <asp:CheckBox runat="server" Checked="false" Visible="false" Font-Bold="true" ID="UtilPortal" Text="Portal User" OnCheckedChanged="UtilPortal_CheckedChanged" />
                                             </td>--%>
                                         </tr>
                                        <tr>
