...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                ...
                                <div class="row">
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" Width="100%" CssClass="table table-bordered table-hover" ID="dataGridResults" AllowPaging="true"
                                            OnPageIndexChanging="OnPageIndexChanging" PageSize="30" CellPadding="4" CellSpacing="2" OnRowCommand="dataGridResults_RowCommand" OnRowDataBound="dataGridResults_RowDataBound">
 <%--                                           <AlternatingRowStyle BackColor="#BFE4FF" />--%>
                                        ...
                                        <Columns>
                                          <asp:TemplateField HeaderText="Reverse" Visible="true">
                                              <ItemTemplate>
                                                <asp:Button runat="Server" ID="btnReverse" CommandName="Action" Text="Reverse" OnClientClick="return confirm('Do you really want to reverse?');" Visible="true" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                              </ItemTemplate>
                                          </asp:TemplateField>
                                        </Columns>
                                        </asp:GridView>
