...
namespace apps
{
    public partial class StanbicVasUssdSessionTransactions : System.Web.UI.Page
    {
        ...
        protected void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                LoadStanbicVasUssdSessionTransactions();
            }
            catch (Exception ex)
            {
                ShowMessage(ex.Message, true);
        ...
        private void LoadStanbicVasUssdSessionTransactions()
        {
            ...
            else
            {
                ...
                dataTable = datapay.GetTransactionsForStanbicVasUssdSessionTransactions(vendorcode, session, fromdate, todate, network, phone);
        ...
        private void LoadRpt()
        {
            ...
            rptName = physicalPath + "\\Bin\\Reports\\StanbicVasUssdSessionTxn.rpt";
