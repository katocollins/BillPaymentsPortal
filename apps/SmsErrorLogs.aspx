<%@ Page Title="" Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="SmsErrorLogs.aspx.cs" Inherits="SmsErrorLogs" %>
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="width: 98%; height: 2px">
                                <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                                    <tr>
                                        <td class="InterfaceHeaderLabel">SMS ERROR LOGS REPORT</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table style="width: 100%; margin-top: 20px;">
                        <tr>
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center; border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6; border-bottom-width: 1px; border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px; border-right-color: #617da6;">
                                <label>TELECOM</label>
                                <asp:DropDownList ID="ddVendor" runat="server" Style="font: menu" Width="70%" Height="30px">
                                    <asp:ListItem Value="">All</asp:ListItem>
                                    <asp:ListItem Value="MTN">MTN</asp:ListItem>
                                    <asp:ListItem Value="AIRTEL">AIRTEL</asp:ListItem>
                                    <asp:ListItem Value="UTL">UTL</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center; border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6; border-bottom-width: 1px; border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px; border-right-color: #617da6;"
                                colspan="2">
                                <label>Keyword</label>
                                <asp:TextBox ID="txtKeyword" runat="server" Style="font: menu" Width="70%" Height="30px" placeholder="e.g bind" />
                            </td>
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center; border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6; border-bottom-width: 1px; border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px; border-right-color: #617da6;"
                                colspan="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-right: #617da6 1px solid; border-top: #617da6 1px solid; border-left: #617da6 1px solid; width: 100px; border-bottom: #617da6 1px solid">
                                            <asp:RadioButton ID="rdExcel" runat="server" Font-Bold="True" GroupName="FileFormat"
                                                Text="EXCEL" /></td>
                                        <td style="border-right: #617da6 1px solid; border-top: #617da6 1px solid; border-left: #617da6 1px solid; width: 100px; border-bottom: #617da6 1px solid">
                                            <asp:Button ID="btnConvert" runat="server" Font-Size="9pt" Height="28px" OnClick="btnConvert_Click"
                            ...
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView runat="server" Width="100%" CssClass="table table-bordered table-hover" ID="dataGridResults" AllowPaging="true"
                                        ...
                                        <%--<Columns>
                                            <asp:ButtonField ButtonType="Button" CommandName="Action" Text="Action" Visible="true" />
                                        </Columns>--%>
                                    </asp:GridView>
                                </div>
                            </div>
