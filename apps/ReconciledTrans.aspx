<%@ Page Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="ReconciledTrans.aspx.cs" Inherits="ReconciledTrans" Title="RECONCILED TRANSACTIONS" %>
            ...
            <td style="width: 98%; height: 2px">
                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="Date1" HeaderText="Date">
                            <HeaderStyle Width="10%" />
                            <ItemStyle Width="10%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="SentToUtility" HeaderText="UtilityNotified">
                            <HeaderStyle Width="8%" />
                            <ItemStyle Width="8%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="Cancelled" HeaderText="Cancelled">
                            <HeaderStyle Width="8%" />
                        </asp:BoundColumn>
