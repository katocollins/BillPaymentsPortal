                    ...
                    <tr>
                        <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                            ...
                            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="InterfaceDropdownList"
                                Width="95%" style="font: menu" OnDataBound="cboVendor_DataBound" Font-Bold="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                            </asp:DropDownList></td>
                        <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                            border-bottom-width: 1px; border-bottom-color: #617da6; vertical-align: middle;
                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td style="width: 30%; text-align: center">
                            <asp:Button ID="btnApprove" runat="server" Font-Size="9pt" Height="23px" OnClick="btnApprove_Click"
