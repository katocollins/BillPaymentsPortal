<%@ Page Title="" Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="CommissionTransactionReport.aspx.cs" Inherits="CommissionTransactionReport" %>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                                ...
                                <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                                    <tr>
                                        <td class="InterfaceHeaderLabel">
                                            COMMISSION TRANSACTIONS REPORT</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                              ...
                              <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                ...
                                border-right-color: #617da6;">
                                <label>
                                    Commission Account</label>
                                <asp:DropDownList ID="ddAccount" runat="server" Style="font: menu" Width="90%">
                                    <asp:ListItem>True</asp:ListItem>
                                    <asp:ListItem>False</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                           ...
                           <%-- <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                            ...
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                ...
                                <label>
                                    Customer Name</label>
                                <asp:TextBox ID="txtName" runat="server" Style="font: menu" Width="90%" placeholder="Enter text" />
                            </td>--%>
                             <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6; border-bottom-width: 1px;
                                border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px;
                        ...
                        <tr><td></td></tr>                     
                            <tr><%--  <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6; border-bottom-width: 1px;
                                border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px;
                                border-right-color: #617da6;">
                                <label>
                            ...
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                ...
                                <div class="button-wrapper">
                                    <asp:Button ID="btnSubmit" runat="server" Height="20px" OnClick="btnSubmit_Click" Text="Search" Width="130px" />
                                </div>
                            </td>
                        </tr>
                        <tr><td></td></tr>
                            ...
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView runat="server" Width="100%" CssClass="table table-bordered table-hover"
                                        ...
                                        PageSize="30" CellPadding="4" CellSpacing="2" OnRowCommand="dataGridResults_RowCommand">
