<%@ Page Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="ViewPrepaidCharges.aspx.cs" Inherits="ViewPrepaidCharges" Title="Untitled Page" %>
            ...
            <td style="width: 98%; height: 2px">
                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <ItemStyle BackColor="InactiveCaption" Font-Bold="False" Font-Italic="False"
                        Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="#333333" />
                    <Columns>
                        <asp:BoundColumn DataField="TranId" HeaderText="TransId">
                        ...
                        <asp:BoundColumn DataField="VendorTranId" HeaderText="AgentRef">
                            <HeaderStyle Width="10%" />
                            <ItemStyle Width="10%" />
                        </asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="CustomerRef" HeaderText="CustRef">
