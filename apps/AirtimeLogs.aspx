<%@ Page Title="" Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="AirtimeLogs.aspx.cs" Inherits="AirtimeLogs" %>
                        ...
                        <tr>
                             ...
                             <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                ...
                                border-right-color: #617da6;">
                                 <asp:Label runat="server" Font-Bold="true">PegPay ID</asp:Label>
                                <asp:TextBox ID="PegPayId" style="width:90%" runat="server" CssClass="form-control nunito-font" placeholder="Enter Pegpay ID" />
                            </td>
                        ...
                        <asp:View runat="server" ID="View4">
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="AirtimeLogsGridView" runat="server" 
                                        ...
                                        <PagerStyle CssClass="cssPager" BackColor="#99CCCC" ForeColor="#003399" HorizontalAlign="Center" />
                                                      <Columns>
                                                            <asp:BoundField DataField="PegPayId" HeaderText="PegPay Id" />
                                                           <asp:BoundField DataField="Request" HeaderText="Request" />
                                                            <asp:BoundField DataField="Response" HeaderText="Response" />
                                                          <asp:BoundField DataField="BalanceAtTelecom" HeaderText="Balance" />
