...
namespace apps
{
    public partial class SearchVendorToken : System.Web.UI.Page
    {
        ...
        private void LoadTransactions()
        {
            ...
            if (cboTranId.Text.Equals(""))
            {
                ...
                ShowMessage("VendorToken is required", true);
                cboTranId.Focus();
            }
            ...
            else
            {
                ...
                DataTable resultTable = bll.CreateDataTable("TransactionIDs", new string[] { "PegPayId", "VendorToken", "CustomerRef", "CustomerTel", "UtilityCode", "Status", "TranAmount", "RecordDate" });

                TransactionIDs = new ArrayList(tranId.Split(','));

                foreach (string TransactionID in TransactionIDs)
                {
                    dataTable = datapay.SearchVendorTokens(TransactionID, fromdate, todate);
        ...
        protected void DataGrid1_PageIndexChanged(object source, DataGridPageChangedEventArgs e)
        {
            try
            {
                ...
                dataTable = datapay.SearchVendorTokens(traniD, fromdate, todate);
        ...
        protected void btnConvert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DateTime todate = bll.ReturnDate(txttoDate.Text.Trim(), 2);
                ArrayList TransactionIDs;
                DataTable resultTable = bll.CreateDataTable("TransactionIDs", new string[] { "PegPayId", "VendorToken", "UtilityCode", "Status", "TranAmount", "RecordDate" });
