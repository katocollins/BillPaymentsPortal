<%@ Page Title="" Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="TransferFailedArchiveToReceived.aspx.cs" Inherits="TransferFailedArchiveToReceived" %>
                                ...
                                <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                                    <tr>
                                        <td class="InterfaceHeaderLabel">
                                           Transfer From Failed Archive To Received</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                             <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                ...
                                border-right-color: #617da6;">
                                 <asp:Label runat="server" Font-Bold="true">TranID</asp:Label>
                                <asp:TextBox ID="TranId" style="width:90%" runat="server" CssClass="form-control nunito-font" placeholder="Enter transaction ID" />
                        ...
                        <asp:View runat="server" ID="View2">
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="FailedTransactionsArchiveLogsGridView" runat="server" 
