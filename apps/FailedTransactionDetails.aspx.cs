...
public partial class FailedTransactionDetails : System.Web.UI.Page
{
    ...
    private DataTable SearchDb()
    {
        ...
        try
        {
            ...
            dataTable = datafile.ExecuteDataSet("GetFailedTransactionDetails", utilityRef,fromdate,toDate).Tables[0];
