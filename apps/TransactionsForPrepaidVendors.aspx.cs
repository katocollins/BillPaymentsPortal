...
namespace apps
{
    public partial class TransactionsForPrepaidVendors : System.Web.UI.Page
    {
...
public static DataTable GetDistinctRecords(DataTable dt, string[] Columns)
   {
       ...
       return dtUniqRecords;
        ...
        private void LoadCsv()
        {
            ...
            ///No.	VendorTranId	TransNo	TranId	CustomerRef	CustomerName	CustomerTel	RecordDate	UtilityTranRef	SentToUtility	TranAmount	PayDate	UtilityCode	Reason	Status	Vendor	Balance

            StringBuilder stringBuilder = new StringBuilder();
            string header = "No.,VendorTranId,TransNo,CustomerRef,CustomerTel,RecordDate,UtilityTranRef,TranAmount,PayDate,UtilityCode,Reason,Status,Balance";
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                string VendortranId = row["VendorTranId"].ToString();
                string transNo = row["TransNo"].ToString();
                string customerRef = row["CustomerRef"].ToString();
                string CustomerTel = row["CustomerTel"].ToString();
                string RecordDate = row["RecordDate"].ToString();
                string UtilityTranRef = row["UtilityTranRef"].ToString();
                string TranAmount = row["TranAmount"].ToString();
                string PayDate = row["PayDate"].ToString();
                string UtilityCode = row["UtilityCode"].ToString();
                ...
                string[] fields = new string[] { no, VendortranId, transNo, customerRef, CustomerTel, RecordDate, UtilityTranRef, TranAmount, PayDate, UtilityCode, Reason, Status, Balance };
