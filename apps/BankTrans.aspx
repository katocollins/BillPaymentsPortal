<%@ Page Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="BankTrans.aspx.cs" Inherits="BankTrans" Title="BANK TRANSACTIONS" %>
            ...
            <td style="width: 98%; height: 5px">
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 98%; border-right: #617da6 1px solid; border-top: #617da6 1px solid; border-left: #617da6 1px solid; border-bottom: #617da6 1px solid;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle; width: 17%; height: 23px; text-align: center; border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6; border-bottom-width: 1px; border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px; border-right-color: #617da6;"><asp:DropDownList ID="cboUtility" runat="server" CssClass="InterfaceDropdownList"
                                Width="95%" style="font: menu" OnDataBound="cboUtility_DataBound">
                        </asp:DropDownList>&nbsp;</td>
                    </tr>
                </table>
            ...
            <td style="width: 98%; height: 2px">
                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="UtilityTranRef" HeaderText="UtilityRef">
                            <HeaderStyle Width="5%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="Vendor" HeaderText="Agent">
                            <HeaderStyle Width="20%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="Teller" HeaderText="Teller" Visible="False">
                            <HeaderStyle Width="10%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="PayDate" HeaderText="Pay Date">
                            <HeaderStyle Width="15%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="PostDate" HeaderText="Date" Visible="False">
                        </asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="SentToUtility" HeaderText="UtilityNotified"></asp:BoundColumn>
                    </Columns>
