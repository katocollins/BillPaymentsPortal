...
public partial class VendorreconTransactionReport : System.Web.UI.Page
{
    ...
    private void LoadReconStatus()
    {
        ...
        ddReconStatus.Items.Insert(0, new ListItem("UNRECONCILED", "0"));
    ...
    private DataTable LoadTransactions()
    {
        ...
        else
        {
            ...
            dataTable = datapay.GetVendorReconciledTransactionsReport(vendorcode, vendortrans, Status, fromdate, todate, reconStatus);
