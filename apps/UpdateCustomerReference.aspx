<%@ Page Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true"
    CodeFile="UpdateCustomerReference.aspx.cs" Inherits="UpdateCustomerReference"
    Title="UPDATE CUSTOMER REFERENCE FOR TRANSACTION" %>
            ...
            <asp:View ID="View2" runat="server">
                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="VendorTranId" HeaderText="Agent-Ref"></asp:BoundColumn>
                        <asp:BoundColumn DataField="CustomerRef" HeaderText="Account"></asp:BoundColumn>
                        <asp:BoundColumn DataField="CustomerName" HeaderText="CustomerName"></asp:BoundColumn>
                        <asp:BoundColumn DataField="PayDate" HeaderText="PayDate"></asp:BoundColumn>
                        <asp:BoundColumn DataField="UtilityCode" HeaderText="Utility"></asp:BoundColumn>
