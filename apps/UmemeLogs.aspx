<%@ Page Title="" Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="UmemeLogs.aspx.cs" Inherits="UmemeLogs" %>
                        ...
                        <asp:View runat="server" ID="View4">
                            <div class="row">
                                <div class="table-responsive">
                                    <asp:GridView ID="UmemeLogsGridView" runat="server" 
