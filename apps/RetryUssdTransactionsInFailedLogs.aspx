<%@ Page Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="RetryUssdTransactionsInFailedLogs.aspx.cs" Inherits="RetryUssdTransactionsInFailedLogs" %>
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                    <tr>
                        <%if (Session["RoleCode"].ToString().Equals("001") && Session["UserBranch"].ToString().Equals("PegPay"))
                            {%>
                        <td class="InterfaceHeaderLabel">RETRY KIL/KRECS/PACMECS/CONLOG/MOWE FAILED TRANSACTIONS</td>
                        <%} %>
                        <%if (Session["UserBranch"].ToString().Equals("KIL"))
                            {%>
                        <td class="InterfaceHeaderLabel">RETRY KIL FAILED TRANSACTIONS</td>
                        <%} %>
                        <%if (Session["UserBranch"].ToString().Equals("REA"))
                            {%>
                        <td class="InterfaceHeaderLabel">RETRY REA FAILED TRANSACTIONS</td>
                        <%} %>
                    </tr>
                </table>
            </td>
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 80%; border-right: #617da6 1px solid; border-top: #617da6 1px solid; border-left: #617da6 1px solid; border-bottom: #617da6 1px solid;">
                    <tr>
                        <%-- <td class="InterfaceHeaderLabel2" style="vertical-align: middle; width: 25%; height: 18px;
                            text-align: center">
                            VENDOR CODE</td>--%>
                        <td class="InterfaceHeaderLabel2" style="vertical-align: middle; width: 25%; height: 18px; text-align: center">VENDOR TRAN ID</td>
                    </tr>
                    <tr>
                            ...
                            <td style="width: 100%; text-align: center;">
                                <asp:GridView ID="DataGrid1" runat="server" AutoGenerateColumns="false" PageSize="30" CellPadding="4" CellSpacing="2" OnItemCommand="BTN_ItemCommand" OnRowCommand="gvOnRowCommand">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField CommandName="btnComplete" HeaderText="Action" Text="SUBMIT">
                                            <HeaderStyle Width="5%" />
