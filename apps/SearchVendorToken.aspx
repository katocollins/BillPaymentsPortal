<%@ Page Title="" Language="C#" MasterPageFile="~/OtherReportsmaster.master" AutoEventWireup="true" CodeFile="SearchVendorToken.aspx.cs" Inherits="SearchVendorToken" %>
        ...
        <tr>
            <td style="width: 98%; height: 2px">
                <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                    <tr>
                        <td class="InterfaceHeaderLabel">SEARCH VENDOR TOKENS</td>
                    </tr>
                </table>
            </td>
        </tr>
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 80%; border-right: #617da6 1px solid; border-top: #617da6 1px solid; border-left: #617da6 1px solid; border-bottom: #617da6 1px solid;">
                    <tr>
                        <%-- <td class="InterfaceHeaderLabel2" style="vertical-align: middle; width: 25%; height: 18px;
                            text-align: center">
                            VENDOR CODE</td>--%>
                        <td class="InterfaceHeaderLabel2" style="vertical-align: middle; width: 25%; height: 18px; text-align: center">VENDOR TOKEN</td>
