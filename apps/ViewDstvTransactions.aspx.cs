...
namespace apps
{
    public partial class ViewDstvTransactions : System.Web.UI.Page
    {
        ...
        protected void btnConvert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable resultTable = bll.CreateDataTable("TransactionIDs", new string[] { "VendorTranId", "Reason/UtilityTranRef" });
                ...
                {
                    DataTable dtResult = bll.CheckDSTVTransactionNew(TransactionID, Session);
