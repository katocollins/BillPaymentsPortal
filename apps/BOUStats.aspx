<%@ Page Language="C#" MasterPageFile="~/ReportMaster.master"  AutoEventWireup="true" CodeFile="BoUStats.aspx.cs" 
                                ...
                                <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                                    <tr>
                                        <td class="InterfaceHeaderLabel">
                                            MONTHLY BOU STATISTICS REPORT</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                ...
                                <label>
                                   Year</label>
                                <asp:TextBox ID="txtYear" runat="server" style="width: 90%; font-family: menu;"></asp:TextBox>
                            </td>
