                                    ...
                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                                        <tr>
                                            <td class="InterfaceHeaderLabel">
                                                COMPLETE TRANSACTION AT MTN</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" Width="100%" CssClass="table table-bordered table-hover" ID="dataGridResults" OnRowCommand="dataGridResults_RowCommand" OnRowDataBound="dataGridResults_RowDataBound">
                                            ...
                                            <asp:TemplateField HeaderText="Edit" Visible="true">
                                              <ItemTemplate>
                                                    <asp:Button ID="btnEdit" runat="server" Text="Complete" CommandName="Complete" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                    <asp:Button ID="btnFail" runat="server" Text="Fail" CommandName="Fail" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
