<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ReportMaster.master" 
    Title="UPDATE UMEME CONNECTION"
    CodeFile="UpdateUmemeConnection.aspx.cs"
     Inherits="UpdateUmemeConnection" %>
    ...
    <div>
                        ...
                        <tr>
                            ...
                            <td  style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                                ...
                                <asp:Button ID="Button1" runat="server" Font-Bold="True" Font-Size="9pt" Height="23px"
                                    OnClick="Button2_Click" Style="font: menu" Text="SWITCH CONNECTION TYPE" Width="20%" />
                            </td>
                        </tr>
        ...
        <asp:MultiView ID="MultiView2" runat="server">
            <asp:View ID="View2" runat="server">
                <h4 style="text-align:center;">ACTIVE CONNECTION</h4>
                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:BoundColumn DataField="ConnectionType" HeaderText="Connection Type" Visible="true"></asp:BoundColumn>
                        <asp:BoundColumn DataField="Name" HeaderText="Connection Name" Visible="true"></asp:BoundColumn>
