...
namespace apps
{
public partial class RentalCollectionsTransaction : System.Web.UI.Page
{
    ...
    {
        bll.LoadLandlords(userBranch, ddVendor);
    ...
    private DataTable SearchDb()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                DataSet ds = bll.ExecuteDataAccess("LiveMerchantDB", "RPC_GeneralTransactionsReport", searchParams);
                dt = ds.Tables[0];
