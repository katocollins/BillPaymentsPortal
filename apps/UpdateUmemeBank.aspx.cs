...
public partial class UpdateUmemeBank : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            datafile.UpdateRUmemeBank(bankcode);
            Response.Redirect(Request.RawUrl);
            ShowMessage("Active Bank set Successfully to " + bankcode, false);

        }
        catch (Exception ee)
        {
            ShowMessage("Active Bank set Successfully", false);
        }
    }
