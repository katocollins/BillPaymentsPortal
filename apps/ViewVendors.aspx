<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="ViewVendors.aspx.cs" Inherits="ViewVendors" Title="VENDORS" %>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView runat="server" Width="100%" CssClass="table table-bordered table-hover" ID="dataGridResults" OnRowCommand="dataGridResults_RowCommand" OnRowDataBound="dataGridResults_RowDataBound">
                                            ...
                                            <asp:TemplateField HeaderText="Edit" Visible="true">
                                              <ItemTemplate>
                                                    <asp:Button ID="Button1" runat="server" Text="Edit" CommandName="EditRow" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />                                                </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                    </div>
