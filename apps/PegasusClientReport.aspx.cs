...
public partial class PegasusClientReport : System.Web.UI.Page
{
    ...
    {
       // bll.LoadReportType(ddClientChoice);

        //ddTranType.Items.Clear();
        //ddTranType.Items.Add(new ListItem("All ", ""));
        //ddTranType.Items.Add(new ListItem("Utilities", "UTILITIES"));
        //ddTranType.Items.Add(new ListItem("Sms", "SMS"));

        ddCategory.Items.Clear();
        ddCategory.Items.Add(new ListItem("All ", ""));
        ddCategory.Items.Add(new ListItem("Prepaid", "PREPAID"));
        ddCategory.Items.Add(new ListItem("PostPaid", "POSTPAID"));
    ...
    private DataTable SearchDb()
    {
        ...
        try
        {
            //string clientchoice = ddClientChoice.SelectedValue;
            string status = ddStatus.SelectedValue;
            string category = ddCategory.SelectedValue;
            string tranType = "";


            dataTable = datafile.ExecuteDataSet("SearchCompanyDetails", status, category, tranType).Tables[0];
