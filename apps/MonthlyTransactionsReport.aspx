<%@ Page Language="C#" MasterPageFile="~/ReportMaster.master"  AutoEventWireup="true" CodeFile="MonthlyTransactionsReport.aspx.cs" 
    Inherits="MonthlyTransactionsReport" Title="MONTHLY TRANSACTIONS REPORT"%>
                                ...
                                <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                                    <tr>
                                        <td class="InterfaceHeaderLabel">
                                            MONTHLY TRANSACTIONS REPORT</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                ...
                                <label>
                                    Month</label>
                                <asp:DropDownList ID="txtMonth" runat="server" Style="font: menu" Width="90%">
                            ...
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                ...
                                <label>
                                   Year</label>
                                <asp:DropDownList ID="txtYear" runat="server" Style="font: menu" Width="90%">
