...
namespace apps
{
    public partial class PostedTrans : System.Web.UI.Page
    {
        ...
        private DataTable formatTable(DataTable dataTable)
        {
            ...
            {
                Header = "ALL AGENTS UPLOADED TRANSACTION(S) BETWEEN [" + fromdate.ToString("dd/MM/yyyy") + " - " + todate.ToString("dd/MM/yyyy") + "]";
            }
            else
            {
                Header = agent_name + " UPLOADED TRANSACTION(S) BETWEEN [" + fromdate.ToString("dd/MM/yyyy") + " - " + todate.ToString("dd/MM/yyyy") + "]";
            }
            //string Header = "BILLING SYSTEM POSTED TRANSACTION(S) BETWEEN [" + fromdate.ToString("dd/MM/yyyy") + " - " + todate.ToString("dd/MM/yyyy") + "]";
