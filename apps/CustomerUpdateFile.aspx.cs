...
namespace apps
{
    public partial class CustomerUpdateFile : System.Web.UI.Page
    {
        ...
        private void ReadFileToRecon(string vendorcode)
        {
            ...
            if (resp.ToUpper().Trim().Equals("SUCCESS"))
            {
                ...
                datafile.SaveCustomerFilePath(vendorcode, customerfile, user);



                ShowMessage("Hello\t" + name + "\t\tCustomer File has been Uploaded Successfully... Processing will start and the report will be sent to your Email Shortly", false);
            }
            else
            {
