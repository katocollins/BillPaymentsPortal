<%@ Page Language="C#" MasterPageFile="~/AccountantMaster.master" AutoEventWireup="true" CodeFile="ResponseRecon.aspx.cs" Inherits="AutoReconciliation" Title="AUTO RECONCILIATION" %>
                ...
                <table style="width: 90%" align="center">
                    <tr>
                        <td style="width: 100%; text-align: center; height: 2px;"><table cellpadding="0" cellspacing="0" class="style12" align="center" width="92%">
                            ...
                            <tr>
                                <td colspan="2" style="vertical-align: top; height: 4px; text-align: left">
                                </td>
                            </tr>
                            <tr>
