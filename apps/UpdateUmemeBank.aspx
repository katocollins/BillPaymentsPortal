<%@ Page Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true"
    CodeFile="UpdateUmemeBank.aspx.cs" Inherits="UpdateUmemeBank"
    ...
    <div>
                        ...
                        <tr>
                            ...
                            <td  style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                                ...
                                <asp:Button ID="Button1" runat="server" Font-Bold="True" Font-Size="9pt" Height="23px"
                                    OnClick="Button2_Click" Style="font: menu" Text="SWITCH BANK" Width="20%" />
                            </td>
                        </tr>
        ...
        <asp:MultiView ID="MultiView2" runat="server">
            <asp:View ID="View2" runat="server">
                <h4 style="text-align:center;">ACTIVE BANK</h4>
