<%@ Page Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true"
    CodeFile="TransactionsForPrepaidVendors.aspx.cs" Inherits="TransactionsForPrepaidVendors"
    Title="TRANSACTIONS" %>
                    ...
                    <tr>
                        <td style="vertical-align: middle; width: 20%; height: 23px; text-align: center;
                            ...
                            &nbsp;<asp:DropDownList ID="cboStatus" runat="server" CssClass="InterfaceDropdownList"
                                Width="95%" Style="font: menu" OnDataBound="cboStatus_DataBound">
                            </asp:DropDownList></td>
                        <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                            border-bottom-width: 1px; border-bottom-color: #617da6; vertical-align: middle;
                            width: 17%; border-top-color: #617da6; height: 23px; text-align: center; border-right-width: 1px;
            ...
            <td style="width: 98%; height: 2px">
                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="CustomerName" HeaderText="Name"></asp:BoundColumn>
                        <asp:BoundColumn DataField="CustomerTel" HeaderText="Telephone"></asp:BoundColumn>
                        <asp:BoundColumn DataField="Vendor" HeaderText="Agent"></asp:BoundColumn>
                        <asp:BoundColumn DataField="PayDate" HeaderText="Pay Date"></asp:BoundColumn>
                        <asp:BoundColumn DataField="UtilityTranRef" HeaderText="TranRef"></asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="RecordDate" HeaderText="Record Date"></asp:BoundColumn>
                    </Columns>
