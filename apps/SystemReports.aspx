<%@ Page Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="SystemReports.aspx.cs" Inherits="SystemReports" Title="TRANSACTIONS" %>
                    ...
                    <table style="width: 100%">
                      ...
                      <table style="width: 100%">
                          <tr>
                            ...
                            border-right-color: #617da6;">
                                    <label>Report</label>
                                    <asp:DropDownList ID="ddReport" runat="server" Style="font: menu" Width="90%" AutoPostBack="true" OnSelectedIndexChanged="ddReport_OnSelectedIndexChanged">
                                        <asp:ListItem>True</asp:ListItem>
                                        <asp:ListItem>False</asp:ListItem>
                                    </asp:DropDownList></td>
                                 <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
