                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 98%; border-right: #617da6 1px solid;
                    ...
                    <tr>
                        ...
                        <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                            ...
                            border-right-color: #617da6">
                            <asp:TextBox ID="txtsessionid" runat="server" Style="font: menu" Width="90%"></asp:TextBox></td>
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 98%; border-right: #617da6 1px solid;
                    ...
                    <tr>
                        ...
                        <td style="border-top-width: 1px; border-left-width: 1px; border-left-color: #617da6;
                            ...
                            width: 17%; border-top-color: #617da6; height: 23px; text-align: center; border-right-width: 1px;
                            border-right-color: #617da6">
                            <asp:TextBox ID="txtCustomerTel" runat="server" Style="font: menu" Width="90%"></asp:TextBox>
                          </td>
        ...
        <td style="width: 98%; height: 2px">
                <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="MSISDN" HeaderText="Tel"></asp:BoundColumn>
                        <asp:BoundColumn DataField="SessionId" HeaderText="SessionId"></asp:BoundColumn>
                        <asp:BoundColumn DataField="Reponse" HeaderText="Reponse"></asp:BoundColumn>
                        <asp:BoundColumn DataField="ResponseDate" HeaderText="RecordDate"></asp:BoundColumn>
                        <asp:BoundColumn DataField="Network" HeaderText="Network"></asp:BoundColumn>
