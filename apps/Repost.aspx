<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Repost.aspx.cs" Inherits="Repost" Title="REPOST TXNS" %>
                    ...
                    <table style="width: 100%">
                      ...
                      <table style="width: 100%">
                          <tr>
                            ...
                            border-bottom-color: #617da6; border-top-color: #617da6; border-right-width: 1px;
                            border-right-color: #617da6;">
                                    <label>Provide one or a comma separated list of transactions</label>
                       ...
                       <hr />
                       <asp:Button ID="btnSearch" Width="130px" Height="30px" runat="server" CssClass="btn btn-success btn-lg" Text="Repost" OnClick="btnSubmit_Click" />                       
                       <hr />
                       <table>
                           <tr>
