<%@ Page Title="" Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="ViewCAATransactions.aspx.cs" Inherits="ViewCAATransactions" %>
                                ...
                                <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                                    <tr>
                                        <td class="InterfaceHeaderLabel">
                                            VIEW CIVIL AVIATION TRANSACTIONS</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="vertical-align: middle; width: 10%; height: 23px; text-align: center;
                                ...
                                <label>Enter Number Plate/Ticket Number(s)</label>
                                <asp:TextBox ID="txtTranIds" runat="server" Style="font: menu" Width="90%" placeholder="Enter text" />
                            </td>
