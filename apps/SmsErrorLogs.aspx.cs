...
namespace apps
{
    public partial class SmsErrorLogs : System.Web.UI.Page
    {
        ...
        {
            //bll.LoadSmsVendors(userBranch, ddVendor);
        ...
        private DataTable SearchDb()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DataSet ds = bll.ExecuteDataAccess("SmsClient", "SmsErrorLogsReports2", searchParams);
                    dt = ds.Tables[0];
        ...
        private string[] GetSearchParameters()
        {
            ...
            string Vendor = ddVendor.SelectedItem.Value;
            string utility = "SMS";// ddUtility.SelectedValue;
        ...
        protected void dataGridResults_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "Action")
                {
                    ...
                    string report = "True";// ddReport.SelectedValue.ToString();
